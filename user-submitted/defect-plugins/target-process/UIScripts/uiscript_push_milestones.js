...
$(document).ready(function() {
  ...
  $("a", button).click(function() {
    ...
    var m_id = uiscripts.context.milestone.id;
    var p_id = uiscripts.context.project.id;

    /* Get the test results using TestRail API */
    var results = [];
    $.ajax({
      url: "/index.php?/api/v2/get_runs/" + p_id + "&milestone_id=" + m_id,
      type: "GET",
      contentType: "application/json",
      dataType: "json",
      success: function(milestoneData) {
        ...
        $.ajax({
          ...
          success: function(milestoneData) {
            ...
            $.ajax({
              url: "/custom/milestone-results.php",
              type: "POST",
              data: {
